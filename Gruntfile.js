...
/*
 * Provides tasks for building and testing the "asteria-hyperion" project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "asteria-hyperion" project:
  grunt.registerTask('build', ['ts:build', 'copy:main',
                               'copy:initTypes', 'copy:buildTypesFile',
                               'clean:build']);

  //--> Task: builds the "asteria-hyperion" API documentation:
